...
createPhysical :: String -> Number -> Number -> Number -> Number -> Number -> Number -> Physical
createPhysical name ix iy w h x y = ({
    name: name
  , pos: vec x y
  , acc: zeroVector
  , vel: zeroVector
...
createBox name = createPhysical name 0.0 0.0

createPaddle :: String -> Number -> Number -> Paddle
createPaddle name = createPhysical name 0.0 0.95 20.0 70.0

createBall :: String -> Number -> Number -> Ball
createBall name = createPhysical name 1.001 1.001 15.0 15.0
